  ...
  return [
    {
      ...
      quote: tr(lang, {
        ...
        en: "«The blues are the roots, everything else is the fruits.»", pl: "«Blues jest korzeniem, wszystko inne to owoce.»",
    ...
    },
    {
      ...
      quote: tr(lang, {
        ...
        en: "«When you play the blues, you tell the truth about life.»", pl: "«Kiedy grasz bluesa, mówisz prawdę o życiu.»",
  ...
  return [
    ...
    { year: "1920",
      ...
      body: tr(lang, {
        ...
        en: "Mamie Smith records 'Crazy Blues' for Okeh Records — the first blues recording by an African American artist. It sells over 75,000 copies in the first month.", pl: "Mamie Smith nagrywa „Crazy Blues” dla Okeh Records — to pierwsze nagranie bluesowe afroamerykańskiej artystki. W pierwszym miesiącu sprzedaje się ponad 75 000 kopii.",
    ...
    { year: "1947",
      title: tr(lang, { no: "Chess Records grunnlegges", en: "Chess Records Founded", pl: "Założenie Chess Records", sv: "Chess Records grundas", de: "Chess Records gegründet" }),
      body: tr(lang, {
        ...
        en: "Leonard and Phil Chess establish Chess Records in Chicago (originally Aristocrat). The label would become the most important blues record company in history.", pl: "Leonard i Phil Chess zakładają Chess Records w Chicago (pierwotnie Aristocrat). Wytwórnia stanie się najważniejszą firmą płytową w historii bluesa.",
...
function ThreeNames() {
  ...
  const aiNote = tr(lang, {
    ...
    en: "AI-generated historical interpretation", pl: "Generowana przez AI interpretacja historyczna",
